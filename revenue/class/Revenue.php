...
session_start();
require('config.php');
class Revenue extends DbConfig {	
    protected $hostName;
    protected $userName;
    protected $password;
	protected $dbName;
	private $userTable = 'ars_users';
	private $infoTable = 'beneficiery_info';
	...
	/*****************'Beneficiery_info methods****************/
	public function listBeneficiery(){		
		$sqlQuery = "SELECT s.id, s.name, s.photo, s.gender, s.dob, s.mobile, s.email, s.current_address, s.father_name, s.mother_name,s.admission_no, s.roll_no, s.admission_date, s.academic_year, c.name as class, se.section 
			FROM ".$this->beneficiery_info." as s
	...
	public function addBeneficiery () {
		...
		if($_POST["sname"]) {			
			...
			echo "Hello11111111111111111111111";	
			echo '".$_POST["sryear"]."';				
			$insertQuery = "INSERT INTO ".$this->infoTable."(sr, sr_year, file_name, file_year, station_name, fir, fir_year, accident_status, death_date, victim_name, if_proof, gender, claim, beneficiary, father_name, mobile, address, bank, account, ifsc, payment_status, payment_date) 
				VALUES ('".$_POST["sr"]."', '".$_POST["sryear"]."', '".$_POST["fileno"]."', '".$_POST["fileyear"]."', '".$_POST["police"]."', '".$_POST["fir"]."', '".$_POST["firyear"]."', '".$_POST["accidentdate"]."', '".$_POST["deathdate"]."', '".$_POST["name"]."', '".$fileName."', '".$_POST["gender"]."', '".$_POST["claim"]."', '".$_POST["bname"]."', '".$_POST["fname"]."', '".$_POST["mobile"]."', '".$_POST["address"]."', '".$_POST["bank"]."', '".$_POST["accountnumber"]."', '".$_POST["ifsc"]."','".$_POST["payment"]."','".$_POST["pay_date"]."')";
			$userSaved = mysqli_query($this->dbConnect, $insertQuery);
		}
	}
